...
const allowedTypes = new Set(Object.values(_events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.ModelLoaderMessageTypes));
    ...
    try {
      ...
      modelWorker.onmessage = (event) => {
        ...
        const typesToForward = [
          _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.WORKER_SCRIPT_READY, 
          _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.WORKER_READY, _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.ERROR, _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.LOADING_STATUS,
          _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.GENERATION_STATUS, _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.GENERATION_UPDATE, _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.GENERATION_COMPLETE, _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.GENERATION_ERROR,
          _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.RESET_COMPLETE
        ];
        ...
        if (typesToForward.includes(type)) {
          ...
          webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.sendMessage({ type, payload }).catch(error => {
      ...
      modelWorker.onerror = (errorEvent) => {
        ...
        webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.sendMessage({ type: _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.WorkerEventNames.ERROR, payload: `Failed to instantiate model worker: ${error.message}` })
...
webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (!workerInstance && message.type !== _events_eventNames_js__WEBPACK_IMPORTED_MODULE_0__.ModelLoaderMessageTypes.INIT) { 
  ...
  if (allowedTypes.has(message.type)) {
      ...
      try {
          const wasmPath = webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.getURL('xenova/transformers/dist/');
          const localModelPath = webextension_polyfill__WEBPACK_IMPORTED_MODULE_1___default().runtime.getURL('models/');
