// src/Controllers/IntegrationsBrowserTab.ts
...
const prefix = '[IntegrationsBrowserTab]';

export function createBrowserContent(): string {
    return `
...
export function setupBrowserTab(container: HTMLElement): void {
